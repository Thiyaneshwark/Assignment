    ...
    internal class Program
    {
        ...
        private static void DisplayEvents(EventRepo eventRepo)
        {
            ...
            if (allEvents != null && allEvents.Count > 0)
            {
                foreach (var ev in allEvents)
                {
                    ...
                    table.AddRow(ev.EventName, ev.EventDate.ToString("yyyy-MM-dd"), ev.EventTime.ToString(@"hh\:mm"));
                }
        ...
        private static void DisplayBookingDetails(EventRepo eventRepo)
        {
            ...
            if (bookingDetails != null)
            {
                ...
                table.AddRow(bookingDetails.BookingId.ToString(), bookingDetails.EventId.ToString(),
                             bookingDetails.NumTickets.ToString(), bookingDetails.TotalCost.ToString("F2"),
                             bookingDetails.BookingDate.ToString("yyyy-MM-dd HH:mm:ss"));
